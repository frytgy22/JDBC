...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        ...
        <button type="button" onclick="window.location.href='${pageContext.request.contextPath}/add'"
    ...
    <span class="navbar-brand float-right">Users on the site: ${applicationScope.sessions}</span>
</nav>
